 ...
 * @param decimals The number of decimal places in the raw amount (default: 18 for YOUR_COIN)
 * @param unit Optional unit to append to the result (e.g., "YOUR_COIN", "GWEI")
